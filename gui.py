    ...
    def __init__(self, root):
        ...
        self.tables = {
            ...
            "Project": [
                ...
                ("Start_date", "Ημερομηνία έναρξης (dd/mm/yy)", r"^\d{1,2}\/\d{1,2}\/\d{2}$", "date"),
                ("End_date", "Ημερομηνία λήξης (dd/mm/yy)", r"^\d{1,2}\/\d{1,2}\/\d{2}$", "date"),
                ("Real_start_date", "Πραγματική ημερομηνία έναρξης (dd/mm/yy)", r"^\d{1,2}\/\d{1,2}\/\d{2}$", "date"),
                ("Real_end_date", "Πραγματική ημερομηνία λήξης (dd/mm/yy)", r"^\d{1,2}\/\d{1,2}\/\d{2}$", "date")
            ],
            "Book": [
                ("ISBN", "ISBN βιβλίου (ακέραιος - 13 ψηφία)", r"^\d{13}$", "entry"),
                ("Title", "Τίτλος βιβλίου (αλφαριθμητικό)", r"^[A-Za-zΑ-ΩΆΈΉΊΌΎΏα-ωάέήίόύώ-]+$", "entry"),
            ...
            "Sale": [
                ...
                ("Date", "Ημερομηνία πώλησης (dd/mm/yy HH:MM:SS)", r"^\d{1,2}\/\d{1,2}\/\d{2}$", "date"),
